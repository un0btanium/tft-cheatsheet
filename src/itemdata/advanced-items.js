...
let advancedItems = {
    ...
    "Guardian Angel": {
        img: "3026",
        effect: "Upon death: Revive with 1000HP after 2 seconds"
    },
    "Bloodthirster": {
        img: "3072",
    ...
    "Guinsoo's Rageblade": {
        img: "3124",
        effect: "On every Basic Attack: Gain an additional 4% attack speed. This effect stacks with no upper limit",
        effectShort: "Basic Attacks grant +4% AS, stacks infinitely"
    },
    "Luden's Echo": {
        img: "3285",
    ...
    "Runaan's Hurricane": {
        img: "3085",
        effect: "On every Basic Attack: Attacks one extra targets with 25% of damage, but can apply on-hit effects",
